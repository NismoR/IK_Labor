...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikmeresvezeto}{Kovács Gábor}
\newcommand{\vikmereshelye}{BME I épület - IB410}
...
\newcommand{\vikcim}{M04 - Felügyeleti irányítás megvalósítása Stateflow környezetben}
\newcommand{\viktanszek}{Irányítástechnika és Informatika Tanszék}
\newcommand{\viklabor}{Irányítástechnika és képfeldolgozás laboratórium 2.}
